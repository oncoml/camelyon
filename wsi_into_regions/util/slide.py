...
TRAIN_PREFIX = "patient_012_node_"
SRC_TRAIN_DIR = BASE_DIR
SRC_TRAIN_EXT = "tif"
DEST_TRAIN_SUFFIX = ""  # Example: "train-"
DEST_TRAIN_EXT = "png"
SCALE_FACTOR = 64
DEST_TRAIN_DIR = BASE_DIR
...
def get_tile_summary_image_filename(slide_number, thumbnail=False):
  ...
  slide = open_slide('patient_012_node_000.tif')
  large_w, large_h = slide.dimensions

  image = open_image('patient_012_node_000.png')
  small_w, small_h = image.size
...
def parse_dimensions_from_image(filename):
    """
